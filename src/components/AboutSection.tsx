      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-gray-400 font-josefin">
          ...
          <div className="bg-gray-900 shadow-sm rounded-lg p-8 border border-gray-800">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed font-josefin">
            ...
            <p className="text-gray-300 mb-8 leading-relaxed font-josefin">
            ...
            <div className="p-6 bg-gray-800 rounded-md border border-gray-700">
              <p className="text-gray-300 italic text-center font-josefin text-sm">
